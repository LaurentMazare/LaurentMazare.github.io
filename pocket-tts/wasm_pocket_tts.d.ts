...
export class Model {
     ...
     */
    generate(token_ids: Uint32Array, frames_after_eos: number, temperature: number): Float32Array;
    generation_step(): Float32Array | undefined;
    constructor(model_weights: Uint8Array, voice_weights: Uint8Array);
    /**
    ...
    sample_rate(): number;
    start_generation(token_ids: Uint32Array, frames_after_eos: number, temperature: number): void;
}
...
export interface InitOutput {
    ...
    readonly model_generate: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    ...
    readonly model_start_generation: (a: number, b: number, c: number, d: number, e: number) => [number, number];
